...
export default class Newdetail extends React.Component {
  ...
  render() {
		...
		html= html + '$(document).ready(function(){ $("img").attr("height", "300px");$("img").attr("width", "100%");});'
    ...
    return (
      <View style={styles.wrapper}>
          	...
          	<ScrollView contentInsetAdjustmentBehavior="automatic" style={styles.scrollview_section}>
		              ...
		              <Text style={styles.title}>{this.state.newItem.title}</Text>
		              <View style={styles.detail}>
		              		
							<Image 
									 source={{uri: 'https://hoplongtech.com/uploads/news/' + this.state.newItem.image_cover,width: width - 30, height: 120*(width - 30)/168}}/>
